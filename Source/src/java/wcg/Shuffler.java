...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Wcg.getIntProperty("wcg.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = Wcg.getBlockchain().getHeight() + 720;
    ...
    private volatile WcgException.NotCurrentlyValidException failureCause;
    ...
    public WcgException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = Wcg.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new WcgException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends WcgException {
