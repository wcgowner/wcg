...
import static wcg.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = Wcg.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = Wcg.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Wcg.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Wcg.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
