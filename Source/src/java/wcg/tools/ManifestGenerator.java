...
import wcg.Wcg;
import wcg.env.service.WcgService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/wcg.manifest.mf", Wcg.class.getCanonicalName(), "./lib");
        String serviceClassName = WcgService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/wcgservice.manifest.mf", serviceClassName, "./lib");
    }
