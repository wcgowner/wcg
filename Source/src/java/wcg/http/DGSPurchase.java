...
import static wcg.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static wcg.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static wcg.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static wcg.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws WcgException {
        ...
        try {
            ...
            if (deliveryDeadline <= Wcg.getEpochTime()) {
