...
public final class GetBlockchainStatus extends APIServlet.APIRequestHandler {
    ...
    protected JSONObject processRequest(HttpServletRequest req) {
        ...
        response.put("application", Wcg.APPLICATION);
        response.put("version", Wcg.VERSION);
        response.put("time", Wcg.getEpochTime());
        ...
        response.put("currentMinRollbackHeight", Wcg.getBlockchainProcessor().getMinRollbackHeight());
