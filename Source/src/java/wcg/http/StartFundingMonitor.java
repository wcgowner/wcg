...
import static wcg.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static wcg.http.JSONResponses.UNKNOWN_ACCOUNT;
import static wcg.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer WCG, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * WCG amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  WcgException        Unable to process request
     */
    @Override
