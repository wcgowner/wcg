...
/**
 * Issue a currency on the WCG blockchain
 * <p>
 * A currency is the basic block of the WCG Monetary System it can be exchanged with WCG, transferred between accounts,
 ...
 * For {@link wcg.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum WCG value per unit to allow the currency to become active
 * For {@link wcg.CurrencyType#RESERVABLE} currency
 ...
 * For {@link wcg.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link wcg.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link wcg.crypto.HashFunction algorithm} used for minting.
 * For {@link wcg.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link wcg.CurrencyType#EXCHANGEABLE} nor {@link wcg.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link wcg.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link wcg.CurrencyType#RESERVABLE} becomes active, in case it is {@link wcg.CurrencyType#CLAIMABLE} the WCG used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link wcg.CurrencyType#RESERVABLE} becomes active, in case it is non {@link wcg.CurrencyType#CLAIMABLE} the WCG used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link wcg.CurrencyType#MINTABLE} currency, the number of units per {@link wcg.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link wcg.http.CurrencyMint}<br>
 * </ul>
 *
 * @see wcg.CurrencyType
 * @see wcg.crypto.HashFunction
 */
