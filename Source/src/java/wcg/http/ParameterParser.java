...
import wcg.Currency;
import wcg.CurrencyBuyOffer;
import wcg.CurrencySellOffer;
...
import static wcg.http.JSONResponses.*;
...
public final class ParameterParser {
    ...
    public static int getNumberOfConfirmations(HttpServletRequest req) throws ParameterException {
        return getInt(req, "numberOfConfirmations", 0, Wcg.getBlockchain().getHeight(), false);
    }
    ...
    public static int getHeight(HttpServletRequest req) throws ParameterException {
        ...
        if (heightValue != null) {
            try {
                ...
                if (height < 0 || height > Wcg.getBlockchain().getHeight()) {
    ...
    public static Transaction.Builder parseTransaction(String transactionJSON, String transactionBytes, String prunableAttachmentJSON) throws ParameterException {
        ...
        if (transactionJSON != null) {
            try {
                ...
                return Wcg.newTransactionBuilder(json);
            } catch (WcgException.ValidationException | RuntimeException | ParseException e) {
            ...
            try {
                ...
                return Wcg.newTransactionBuilder(bytes, prunableAttachments);
            } catch (WcgException.ValidationException|RuntimeException | ParseException e) {
                Logger.logDebugMessage(e.getMessage(), e);
                JSONObject response = new JSONObject();
    ...
    public static Attachment.TaggedDataUpload getTaggedData(HttpServletRequest req) throws ParameterException, WcgException.NotValidException {
