...
public final class GetNextBlockGenerators extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        if (block == null) {
            curBlock = Wcg.getBlockchain().getLastBlock();
        } else {
            try {
                curBlock = Wcg.getBlockchain().getBlock(Convert.parseUnsignedLong(block));
                if (curBlock == null) {
        ...
        */
        ...
        Block curBlock = Wcg.getBlockchain().getLastBlock();
