...
public abstract class WcgException extends Exception {

    protected WcgException() {
        super();
    }

    protected WcgException(String message) {
        super(message);
    }

    protected WcgException(String message, Throwable cause) {
        super(message, cause);
    }

    protected WcgException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends WcgException {
    ...
    public static final class WcgIOException extends IOException {

        public WcgIOException(String message) {
            super(message);
        }

        public WcgIOException(String message, Throwable cause) {
            super(message, cause);
        }
