...
public class DesktopMode implements RuntimeMode {
    ...
    public void launchDesktopApplication() {
        ...
        try {
            desktopApplication = Class.forName("wcgdesktop.DesktopApplication");
            desktopApplication.getMethod("launch").invoke(null);
        } catch (ReflectiveOperationException e) {
            Logger.logInfoMessage("wcgdesktop.DesktopApplication failed to launch", e);
        }
    }
    ...
    public void shutdown() {
        ...
        try {
            ...
            Logger.logInfoMessage("wcgdesktop.DesktopApplication failed to shutdown", e);
        }
    }
