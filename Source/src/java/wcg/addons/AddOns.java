...
import wcg.Wcg;
import wcg.http.APIServlet;
import wcg.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Wcg.getStringListProperty("wcg.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Wcg.getBooleanProperty("wcg.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Wcg.isDesktopApplicationEnabled() ? "wcgdesktop.policy" : "wcg.policy");
