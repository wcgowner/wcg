...
/**
 * Java LogManager extension for use with Wcg
 */
public class WcgLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Wcg log manager
     *
     ...
     * done terminating the Wcg processes.
     */
    public WcgLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Wcg shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Wcg shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void wcgShutdown() {
        super.reset();
