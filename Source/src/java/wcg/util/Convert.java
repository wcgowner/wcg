...
//        return "WCG-" + Crypto.rsEncode(accountId);
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws WcgException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new WcgException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseWCG(String wcg) {
        return parseStringFraction(wcg, 8, Constants.MAX_BALANCE_WCG);
    }
