...
import wcg.WcgException.WcgIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  WcgIOException      Maximum count exceeded
     */
    private void incCount(long c) throws WcgIOException {
        count += c;
        if (count > limit)
            throw new WcgIOException("Maximum size exceeded: " + count);
    }
}
