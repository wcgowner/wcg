...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws WcgException.NotValidException;

        Transaction build(String secretPhrase) throws WcgException.NotValidException;
    ...
    void validate() throws WcgException.ValidationException;
