...
RemoteNode.prototype.getUrl = function () {
    //suse 03/01/2017 - check if port is defined
    if (this.port) return (this.isSsl ? "https://" : "http://") + this.address + ":" + this.port;
    else return (this.isSsl ? "https://" : "http://") + this.address;
    // return (this.isSsl ? "https://" : "http://") + this.address;
};
