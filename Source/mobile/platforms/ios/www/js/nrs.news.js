	...
	NRS.pages.news = function() {
      ...
      var settingsReddit = {
         ...
         "filter": function(entry, tokens) {
            return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("WCG tipping bot has arrived") == -1
         },
         "ssl": ssl
      };

      $("#wcgforum_news").rss("http://forum.r6s6.com/index.php?action=.xml;type=rss", settings, NRS.newsLoaded);
      //$("#reddit_news").rss("http://www.reddit.com/r/WCG/.rss", settingsReddit, NRS.newsLoaded);
      //$("#wcgcoin_blogspot_news").rss("http://wcgcoin.blogspot.com/feeds/posts/default", settings, NRS.newsLoaded);
      //$("#wcger_news").rss("http://wcger.org/feed/", settings, NRS.newsLoaded);
		NRS.pageLoaded();
	};
