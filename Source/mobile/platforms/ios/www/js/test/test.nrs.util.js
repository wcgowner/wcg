...
QUnit.test("convertToWCG", function (assert) {
    assert.equal(NRS.convertToWCG(200000000), "2", "whole");
    assert.equal(NRS.convertToWCG(20000000), "0.2", "fraction");
    assert.equal(NRS.convertToWCG(-200000000), "-2", "negative");
    assert.equal(NRS.convertToWCG(-20000000), "-0.2", "fraction.negative");
    assert.equal(NRS.convertToWCG(-220000000), "-2.2", "whole.fraction.negative");
    assert.equal(NRS.convertToWCG(2), "0.00000002", "nqt");
    assert.equal(NRS.convertToWCG(-2), "-0.00000002", "nqt.negative");
    assert.equal(NRS.convertToWCG(new BigInteger(String(2))), "0.00000002", "input.object");
    assert.equal(NRS.convertToWCG("hi"), "0.00000188", "alphanumeric"); // strange behavior of BigInteger don't do that
    assert.throws(function () {
        NRS.convertToWCG(null);
    }, {
...
QUnit.test("formatAmount", function (assert) {
    ...
    assert.equal(NRS.formatAmount("123456700000000", true, true), Number("1234567").toLocaleString(), "wcg.rounding");
...
QUnit.test("getAccountLink", function (assert) {
    ...
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831 }, "entity"), "<a href='#' data-user='WCG-XKA2-7VJU-VZSY-7R335' class='show_account_modal_action user-info'>/</a>", "numeric");
    assert.equal(NRS.getAccountLink({ entityRS: "WCG-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='WCG-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>WCG-XK4R-7VJU-6EQG-7R335</a>", "RS");
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831, entityRS: "WCG-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='WCG-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>WCG-XK4R-7VJU-6EQG-7R335</a>", "numeric.and.RS");
    NRS.contacts = { "WCG-XK4R-7VJU-6EQG-7R335": { name: "foo" }};
    assert.equal(NRS.getAccountLink({ entityRS: "WCG-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='WCG-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>foo</a>", "contact");
    NRS.accountRS = "WCG-XK4R-7VJU-6EQG-7R335";
    assert.equal(NRS.getAccountLink({ entityRS: "WCG-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='WCG-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>You</a>", "you");
    assert.equal(NRS.getAccountLink({ entityRS: "WCG-XK4R-7VJU-6EQG-7R335" }, "entity", "WCG-XK4R-7VJU-6EQG-7R335", "My Precious"), "<a href='#' data-user='WCG-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>My Precious</a>", "force.account.name");
    assert.equal(NRS.getAccountLink({ entityRS: "WCG-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, true), "<a href='#' data-user='WCG-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>WCG-XK4R-7VJU-6EQG-7R335</a>", "maintain.rs.format");
    assert.equal(NRS.getAccountLink({ entityRS: "WCG-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, undefined, "btn btn-xs"), "<a href='#' data-user='WCG-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info btn btn-xs'>You</a>", "add.class");
    NRS.contacts = null;
    NRS.accountRS = null;
    NRS.constants.GENESIS = 1739068987193023818;
    NRS.constants.GENESIS_RS = "WCG-MR8N-2YLS-3MEQ-3CMAJ";
    assert.equal(NRS.getAccountLink({ entityRS: NRS.constants.GENESIS_RS }, "entity"), "<a href='#' data-user='WCG-MR8N-2YLS-3MEQ-3CMAJ' class='show_account_modal_action user-info'>Genesis</a>", "genesis");
});
