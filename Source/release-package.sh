...
then
echo obfuscate
/opt/proguard/bin/proguard.sh @wcg.pro
...
cd -
zip -q -X -r ${PACKAGE}.zip wcg -x \*/.idea/\* \*/.gitignore \*/.git/\* \*/\*.log \*.iml wcg/conf/wcg.properties wcg/conf/logging.properties wcg/conf/localstorage/\*
rm -rf wcg
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/wcg/downloads/${PACKAGE}.zip" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/wcg/downloads/${PACKAGE}.sh" >> ${CHANGELOG}
echo >> ${CHANGELOG}
echo "sha256:" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/wcg/downloads/${PACKAGE}.exe" >> ${CHANGELOG}
echo >> ${CHANGELOG}
#echo "sha256:" >> ${CHANGELOG}
#sha256sum ${PACKAGE}.exe >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/wcg/downloads/wcg-installer-${VERSION}.dmg" >> ${CHANGELOG}
echo >> ${CHANGELOG}

echo "The exe, dmg, and sh packages must have a digital signature by \"Stichting WCG\"." >> ${CHANGELOG}
