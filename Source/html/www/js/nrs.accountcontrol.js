...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount WCG",
			labelI18n: "amount_wcg",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumWCG",
			addonText: "WCG",
			addonI18n: "wcg_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_wcg', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceWCG';
		context['addonText'] = 'WCG';
		context['addonI18n'] = 'wcg_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_wcg', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
