...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.updateNotificationUI = function() {
		...
		if (totalCount > 0) {
			$menuItem.find('span .nm_inner_subtype').css('backgroundColor', '#b73f27');
			...
			var $markReadLink= $("<a href='#' style='color:#bc573c;'>" + $.t('notifications_mark_as_read', 'Mark all as read') + "</a>");
