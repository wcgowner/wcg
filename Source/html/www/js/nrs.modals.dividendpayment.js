...
var NRS = (function(NRS, $, undefined) {
    ...
    $("#dividend_payment_amount_per_share, #dividend_payment_height").on("blur", function() {
        ...
        var amountWCGPerShare = $modal.find("#dividend_payment_amount_per_share").val();
        ...
        if (amountWCGPerShare && /^\d+$/.test(height)) {
            NRS.getAssetAccounts(NRS.getCurrentAsset().asset, height,
                function (response) {
                    ...
                    var priceNQT = new BigInteger(NRS.calculatePricePerWholeQNT(NRS.convertToNQT(amountWCGPerShare), NRS.getCurrentAsset().decimals));
                    var totalWCG = NRS.calculateOrderTotal(totalQuantityQNT, priceNQT);
